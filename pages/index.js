    ...
    <Layout>
      ...
      <section className="about">
        ...
        <div className="personal-info">
          ...
          <p>View my resume by clicking the image below.</p>
        </div>
      </section>
      <section className="resume">
        <h2>Resume</h2>
        <a href="/images/home/resume.jpg"><img className="resume-img" src="/images/home/resume.jpg" alt="Logan Rundquist's resume"/></a>
      </section>
    </Layout>
  );
}